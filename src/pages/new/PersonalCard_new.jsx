...
import { MdOutlineCancel, MdOutlineDone, MdOutlineSave } from 'react-icons/md'
import Sidebar from '../../components/sidebar/Sidebar'
import TopBar from '../../components/topBar/topBar'

const PersonalCard_new = () => {
  return (
    <div>
      ...
      <div className="flex flex-1">
        ...
        <div className="p-4 flex w-[90%] min-w-[90%]">
          <div className="border text-gray-600 rounded-md w-full min-w-full">
            ...
            <div className="p-4">
              <div>
                <span className="text-[#002060]">Last name: </span>
                <input
                  type="text"
                  name="emplLastName"
                  id="emplLastName"
...
export default PersonalCard_new